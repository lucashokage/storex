  ...
  const handleGoogleRegister = async () => {
    ...
    try {
      ...
      if (success) {
        ...
        setError("No se pudo registrar con Google. Por favor, intenta de nuevo.")
      }
    } catch (err) {
        ...
        <div className="flex flex-col items-center justify-center min-h-[80vh]">
          ...
          <Card className="w-full max-w-md shadow-lg">
            <CardHeader className="space-y-1">
              ...
              <CardDescription className="text-center">Ingresa tus datos para registrarte en Tienda X</CardDescription>
            </CardHeader>
